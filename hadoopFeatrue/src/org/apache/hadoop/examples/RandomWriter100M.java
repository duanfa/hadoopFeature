 ...
 * </configuration></xmp>
 * 
 * Equivalently, {@link RandomWriter100M} also supports all the above options
 * and ones supported by {@link GenericOptionsParser} via the command-line.
 */
public class RandomWriter100M extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {    
    ...
    job.setJarByClass(RandomWriter100M.class);
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new RandomWriter100M(), args);
    System.exit(res);
  }
